...
- [Get Started](./get-started.md) – Learn how to deploy SlimFaas on Kubernetes or Docker Compose.
- [Functions](./functions.md) – See how to call functions synchronously or asynchronously.
- [Events](./events.md) – Explore how to use internal synchronous publish/subscribe events.
- [Jobs](./jobs.md) – Learn how to define and run one-off jobs.
- [Planet Saver](./planet-saver.md) – See how to start and monitor replicas from a JavaScript frontend.
- [How It Works](./how-it-works.md) – Dive into SlimFaas’s architecture and design.
