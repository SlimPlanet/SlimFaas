...
| `expiration`         | Optional | unsigned short int                                                 | Cache time for the OpenAPI document, in minutes (set to 0 to disable caching)   | Avoid multiple requests to your OpenAPI document                                                                                                                                          | `?expiration=10`                                   |
