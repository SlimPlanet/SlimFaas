...
public class SlimFaasOptionsTests
{
    ...
    public void SlimFaasOptions_ShouldUseDefaultValues()
    {
        ...
        Assert.Equal(8, options.MetricsScraping.MaxConcurrentTargets);
    ...
    public void SlimFaasOptions_MetricsScraping_ShouldBindFromConfiguration()
    {
        var configuration = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["SlimFaas:MetricsScraping:MaxConcurrentTargets"] = "4",
        ...
        Assert.Equal(4, options.MaxConcurrentTargets);
    ...
    [InlineData("MaxConcurrentTargets", "0")]
