...
const FUNCTIONS_ALL_DOWN: FunctionStatusDetailed[] = [
  ...
  },
  {
    ...
    Retry: { DefaultAsync: { HttpTimeout: 120, TimeoutRetries: [2, 4, 8], HttpStatusRetries: [500, 502, 503] }, DefaultPublish: { HttpTimeout: 120, TimeoutRetries: [2, 4, 8], HttpStatusRetries: [500, 502, 503] } },
